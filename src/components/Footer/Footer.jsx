...
export const Footer = () => {
    ...
    const renderServices = () => (
        <div className="footer-services-columns">
            <ul>
                <li><a href="#">Graphic Design & Digital Illustration</a></li>
                <li><a href="#">Influencer Campaigns</a></li>
                <li><a href="#">Collaborations & Acquisition Marketing</a></li>
                <li><a href="#">Alpha Calls</a></li>
                <li><a href="#">PPC Marketing</a></li>
                <li><a href="#">Strategy & Advisory</a></li>
            </ul>
            <ul>
                <li><a href="#">Discord Growth</a></li>
                <li><a href="#">Influencer Campaigns</a></li>
                <li><a href="#">Twitter Space Packages & Hosting</a></li>
                <li><a href="#">Development</a></li>
                <li><a href="#">Graphic Design & Digital</a></li>
                <li><a href="#">B2B & B2C Campaigns</a></li>
            </ul>
        </div>
    );
